...
var GridPagination = React.createClass({
    ...
    render: function(){
        ...
        if(this.props.currentPage > 0){
            previous = <button type="button" onClick={this.props.previous}
        ...
        if(this.props.currentPage !== (this.props.maxPage -1)){
            next = <button type="button" onClick={this.props.next}
              className="btn btn-primary waves-effect">{this.props.nextText}{this.props.nextIconComponent}
            </button>
        }
