...
namespace ColegioTerciario
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<ColegioTerciarioContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            var roleStore = new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<ColegioTerciarioContext>()));
            return roleStore;
        }
    }
}
